...
export class NDimVector<NDim extends Dim> {
     ...
     */
    public static getComponents<N extends Dim>(vector: Tuple<N> | NDimVector<N>): Tuple<N> {
        return vector instanceof NDimVector ? vector.components : vector
    }

    public get mappedComponents(): NDimVectorComponents<NDim> {
        return this.components.reduce((acc, comp, i) => ({ ...acc, [VectorComponentLabels[i]]: comp }), {} as NDimVectorComponents<NDim>)
    }
     ...
     */
    public sub(other: Tuple<NDim, Dim> | NDimVector<NDim>): NDimVector<NDim> {
     ...
     */
    public midpoint(other: Tuple<NDim, number> | NDimVector<NDim>): NDimVector<NDim> {
